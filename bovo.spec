...
Version  : 19.08.1
Release  : 11
URL      : https://download.kde.org/stable/applications/19.08.1/src/bovo-19.08.1.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.1/src/bovo-19.08.1.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.1/src/bovo-19.08.1.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567691485
mkdir -p clr-build
pushd clr-build
