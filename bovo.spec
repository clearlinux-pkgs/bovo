...
Version  : 19.08.2
Release  : 12
URL      : https://download.kde.org/stable/applications/19.08.2/src/bovo-19.08.2.tar.xz
Source0  : https://download.kde.org/stable/applications/19.08.2/src/bovo-19.08.2.tar.xz
Source1 : https://download.kde.org/stable/applications/19.08.2/src/bovo-19.08.2.tar.xz.sig
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1570731662
mkdir -p clr-build
pushd clr-build
