...
Source0  : https://download.kde.org/stable/release-service/21.12.2/src/bovo-21.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.12.2/src/bovo-21.12.2.tar.xz.sig
...
%prep
%setup -q -n bovo-21.12.2
cd %{_builddir}/bovo-21.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644009580
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/bovo-21.12.2/COPYING %{buildroot}/usr/share/package-licenses/bovo/3860f7708aae6a8ddfe8483263b2a5f29b83c975
cp %{_builddir}/bovo-21.12.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/bovo/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang bovo
