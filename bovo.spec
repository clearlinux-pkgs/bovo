...
Source0  : https://download.kde.org/stable/release-service/23.08.2/src/bovo-23.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.2/src/bovo-23.08.2.tar.xz.sig
...
%prep
%setup -q -n bovo-23.08.2
cd %{_builddir}/bovo-23.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697243162
mkdir -p clr-build
pushd clr-build
