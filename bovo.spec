...
Source0  : https://download.kde.org/stable/release-service/22.04.2/src/bovo-22.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.2/src/bovo-22.04.2.tar.xz.sig
...
%prep
%setup -q -n bovo-22.04.2
cd %{_builddir}/bovo-22.04.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1654829439
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/bovo-22.04.2/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/bovo/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/bovo-22.04.2/COPYING %{buildroot}/usr/share/package-licenses/bovo/3860f7708aae6a8ddfe8483263b2a5f29b83c975
cp %{_builddir}/bovo-22.04.2/COPYING.DOC %{buildroot}/usr/share/package-licenses/bovo/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang bovo
