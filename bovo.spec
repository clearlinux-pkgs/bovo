...
Version  : 23.08.4
Release  : 60
URL      : https://download.kde.org/stable/release-service/23.08.4/src/bovo-23.08.4.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.08.4/src/bovo-23.08.4.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.4/src/bovo-23.08.4.tar.xz.sig
...
%prep
%setup -q -n bovo-23.08.4
cd %{_builddir}/bovo-23.08.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1702950129
mkdir -p clr-build
pushd clr-build
