...
Source0  : https://download.kde.org/stable/release-service/20.12.0/src/bovo-20.12.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.12.0/src/bovo-20.12.0.tar.xz.sig
...
%prep
%setup -q -n bovo-20.12.0
cd %{_builddir}/bovo-20.12.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1607703725
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/bovo-20.12.0/COPYING %{buildroot}/usr/share/package-licenses/bovo/3860f7708aae6a8ddfe8483263b2a5f29b83c975
cp %{_builddir}/bovo-20.12.0/COPYING.DOC %{buildroot}/usr/share/package-licenses/bovo/bd75d59f9d7d9731bfabdc48ecd19e704d218e38
pushd clr-build
%make_install
popd
%find_lang bovo
