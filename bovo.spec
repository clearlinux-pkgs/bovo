...
Source0  : https://download.kde.org/stable/release-service/22.08.0/src/bovo-22.08.0.tar.xz
...
%prep
%setup -q -n bovo-22.08.0
cd %{_builddir}/bovo-22.08.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1661541076
mkdir -p clr-build
pushd clr-build
