...
Version  : 23.04.1
Release  : 51
URL      : https://download.kde.org/stable/release-service/23.04.1/src/bovo-23.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/23.04.1/src/bovo-23.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.04.1/src/bovo-23.04.1.tar.xz.sig
...
%prep
%setup -q -n bovo-23.04.1
cd %{_builddir}/bovo-23.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1684786385
mkdir -p clr-build
pushd clr-build
