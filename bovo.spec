...
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/bovo-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/bovo-25.04.0.tar.xz.sig
...
%setup -q -n bovo-25.04.0
cd %{_builddir}/bovo-25.04.0
pushd ..
cp -a bovo-25.04.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744920283
mkdir -p clr-build
pushd clr-build
